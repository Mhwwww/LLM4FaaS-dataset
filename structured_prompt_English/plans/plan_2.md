...
MORNING PLAN:
Draw the curtains, the music player starts playing, the coffee machine makes coffee

LEAVE HOME PLAN:
Lights and door closed, sockets disconnected except for refrigerator

MOVIE PLAN:
Close the curtains, dim the lights, and turn on the TV to play your favorite show.
