...
MORNING PLAN:
When the sensor senses that the light intensity reaches a certain value, open the curtains, turn off the bedroom lights, turn on the music player to listen to music, start the coffee machine, and make a cup of coffee
