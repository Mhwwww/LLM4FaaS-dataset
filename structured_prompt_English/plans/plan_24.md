...
MORNING PLAN:
In the morning, open the curtains, turn on the lights if it is cloudy, make coffee, and play music when the coffee is ready.

LEAVE HOME PLAN:
If it is sunny, open the curtains, turn off the lights and sockets, and lock the door.
