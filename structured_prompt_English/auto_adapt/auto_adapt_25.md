...
Temperature:
When the indoor temperature reaches 26℃, please turn on the air conditioner to cool down

Humidity:
When the indoor humidity is below 36 degrees, please turn on the air conditioner to humidify.

Light Intensity:
Please draw the curtains when the indoor light intensity is higher than 80
