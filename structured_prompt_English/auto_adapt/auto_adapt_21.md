...
Temperature:
When the temperature is higher than 26°, the air conditioner will automatically turn on and adjust automatically

Humidity:
Humidity regulation is normal

Light Intensity:
Automatically open the curtains when the sun is strong at noon
