...
Temperature:
Automatically turn on the air conditioner when the temperature is above 26 degrees

Humidity:
When the temperature is higher than 10, the air conditioner will be turned on automatically

Light Intensity:
Turn on the air conditioner when it is above 20
