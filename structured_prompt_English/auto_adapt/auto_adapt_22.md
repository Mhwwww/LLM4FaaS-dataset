...
Temperature:
When the temperature of all spaces in the home is higher than 26 degrees, all air conditioners will be automatically turned on, and all windows will be closed at the same time when the air conditioners are turned on.

Humidity:
When humidity is less than 30%, the humidifier will be automatically activated

Light Intensity:
If the indoor light intensity is less than 150 lux, turn up the lights; if it is greater than 11080 lux, draw the curtains and turn on the indoor lights.
