...
When the front door is opened, the curtains are opened, and the music player is turned on, when the indoor temperature is higher than 24℃, open the windows, when the temperature is higher than 27℃, close the windows and start the air conditioner, when the humidity is lower than 36, start the air conditioner humidification, when the indoor light intensity is lower than 40, turn on the indoor lights, when the TV is turned on, turn off the music player, close the curtains, and dim the indoor light
