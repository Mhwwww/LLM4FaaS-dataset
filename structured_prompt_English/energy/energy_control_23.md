...
When the light intensity increases, the light turns off automatically. When the indoor temperature is below 20 degrees, turn on the heater. From Monday to Friday, the robot vacuum cleaner can work. When you come back from get off work, if the humidity is insufficient, it can automatically humidify.
