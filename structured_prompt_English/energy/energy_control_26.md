...
When the air conditioner in the bedroom or living room is turned on, please close the windows of the room; when the indoor temperature is higher than 26 degrees Celsius, if the outdoor temperature is lower than 26 degrees Celsius, please open the windows.
