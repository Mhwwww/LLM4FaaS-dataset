...
Automatically close windows when the air conditioner is turned on, automatically turn off the air conditioner when the indoor temperature is below 20 degrees, automatically turn off or dim the lights when the light is strong, and automatically turn off the music player and TV when people leave the house
